    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4 p-0 pr-1">
                <div class="jumbotron p-3">
                    @if($sales and $sales->count() > 0)
                        <span class="h2 d-block text-center">@user('Retailer'){{$sales->sum('Payed')}}@elseuser('Distributor'){{$sales->sum('PayableAmount')}}@enduser PKR</span>
                    @else
            ...
            @user('Retailer')
                <div class="col-md-4 p-0 pr-1">
                    <div class="jumbotron p-3">
                        <span class="h2 d-block text-center">{{$sales->sum(function($sale){
            ...
            <div class="col-md-4 p-0">
                <div class="jumbotron p-3">
                    @if($sales and $sales->count() > 0)
                        <span class="h2 d-block text-center">@user('Retailer'){{$sales->last()->Payed}}@elseuser('Distributor'){{$sales->last()->PayableAmount}}@enduser PKR</span>
                    @else
                        <span class="h2 d-block text-center">N/A</span>
                    @endif
