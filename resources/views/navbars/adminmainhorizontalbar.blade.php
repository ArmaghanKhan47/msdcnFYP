        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto d-block d-md-none">
                    @auth('admin')
                        ...
                        <li class="nav-item"><a href="{{route('admin.registered-users.index', ['type' => 'retailers'])}}" class="nav-link">Retailers</a></li>
                        <li class="nav-item"><a href="{{route('admin.registered-users.index', ['type' => 'distributors'])}}" class="nav-link">Distributors</a></li>
